...
class AddVideoBlocValidator {
  final Translation translation;

  AddVideoBlocValidator(this.translation) : assert(translation != null);
...
class AddVideoBloc extends BlocBase {
  ...
  final AddVideoBlocValidator validator;

  AddVideoBloc({@required this.validator}) : assert(validator != null);
