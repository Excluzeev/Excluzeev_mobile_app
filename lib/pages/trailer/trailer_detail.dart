...
class _TrailerDetailPageState extends State<TrailerDetailPage> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.network(widget.trailer.videoUrl);
...
//      });
  ...
  _comment() async {
    ...
    CommentsBuilder commentsBuilder = CommentsBuilder()
        ...
        ..trailerId = widget.trailer.trailerId
        ..commentId = commentId;

    Snapshot<Comments> snapshot = await _trailerManager.addComment(commentsBuilder.build());
  ...
  Widget _buildCommentItem(BuildContext context, DocumentSnapshot snapshot, Animation animation, int index) {
...
//              child: VideoPlayer(_controller),
            ...
            Container(
              child: FirestoreAnimatedList(
                shrinkWrap: true,
                query: _trailerManager.trailerCommentQuery(widget.trailer.trailerId).snapshots(),
