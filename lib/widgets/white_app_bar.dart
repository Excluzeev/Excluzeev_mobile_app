...
class _FloatingWhiteAppBar extends StatefulWidget {
  ...
  @override
  _FloatingWhiteAppBarState createState() => _FloatingWhiteAppBarState();
}
...
class _SliverWhiteAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(
    ...
    return floating ? _FloatingWhiteAppBar(child: appBar) : appBar;
  }
...
class SliverWhiteAppBar extends StatefulWidget {
  ...
  @override
  _SliverWhiteAppBarState createState() => _SliverWhiteAppBarState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _SliverWhiteAppBarDelegate(
