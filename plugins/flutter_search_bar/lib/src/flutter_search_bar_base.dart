...
class SearchBar {
  ...
  WhiteAppBar buildAppBar(BuildContext context) {
  ...
  ///
  WhiteAppBar buildSearchBar(BuildContext context) {
    ...
    Color buttonColor = inBar
        ...
        : (colorBackButton
            ...
            : Colors.grey.shade400);
    Color buttonDisabledColor = inBar ? Colors.grey : Colors.grey.shade300;

    Color textColor = inBar ? Colors.black54 : Colors.black54;

    return new WhiteAppBar(
      leading: IconButton(
  ...
  WhiteAppBar build(BuildContext context) {
